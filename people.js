document.addEventListener('DOMContentLoaded', function() {
    const apiKey = 'lmL1Gi_dPrhUYZS1WezGzOGMJtcuWw1FqXW95vyMKqI'; // Replace with your API key
    ...
    fetch(apiUrl)
        ...
        .then(data => {
            ...
            data.forEach(image => {
                ...
                overlay.innerHTML = `
                    <h3>${image.description || 'people'}</h3>
                    <p>${image.alt_description || 'people photography.'}</p>
